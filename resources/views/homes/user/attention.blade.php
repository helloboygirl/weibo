                ...
                <div class="container" >
                    ...
                    <div class="container">
                        ...
                        <div class="col-md-8 sidebar" id="tiezi">  
                         ...
                         <!-- 粉丝遍历的地方 -->
                         @foreach($res as $k=>$v)
                            <div id="im{{$v->uid}}" style="width: 260px;height: 70px;float: left;margin: 10px;background-color: #F2F2F5">
                                    <!-- 头像 -->
                                    <div style="margin: 10px;float: left;margin-top: 15px;display:inline">
