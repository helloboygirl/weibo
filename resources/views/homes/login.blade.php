...
<html>
    ...
    <head>
        ...
        <link title="MYWEIBO" href="" type="application/opensearchdescription+xml" rel="search">
    ...
    <body class="FRAME_main B_index">
                            ...
                            <div class="gn_header clearfix" style="width:1000px;">
                                ...
                                <div class=" gn_search_v2">
                                    ...
                                    <form action="/home/search" method="get">
                                        ...
                                        name="search" type="text" style="height:25px" placeholder="精彩生活，FANS搜索">
                            ...
                            <div >
                                <div  style="margin: 10px;padding:10px;line-height: 30px;">
                                    ...
                                    <a href="/home/job/{{$j->id}}">
                                        <span style="font-size: 14px;background-color: #F2F2F5;padding:5px;margin:10px;border-radius: 10px;">
                                            {{$j->job}}
                                        </span>
                                    </a>
        ...
        <div id="plc_bot">
            ...
            <div class="WB_footer S_bg2">
                <!-- 友情链接 -->
                <div class="other_link S_bg1 clearfix T_add_ser" style="background-color: #FFFFFF">
                    <p class="copy_v2">
                        @foreach($link as $k=>$v)
                            @if($v->status==0)
